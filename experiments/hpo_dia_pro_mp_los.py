...
from multitask_doc_classification_dia_pro_mp_los import doc_classification
...
def run_hpo(args):
    ...
    analysis = ray.tune.run(
        run_wrapper,
        search_alg=search,
        local_dir='/data_dir/MTL/experiments/logs_tensor/debug_all/',
        scheduler=scheduler,
        fail_fast=True,
        **config
    )
