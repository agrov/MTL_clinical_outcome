...
def doc_classification(args):
    task_config='/data_dir/MTL/experiments/configs/dia_pro_mp_config.yaml'
    run_name='all_0'
    model_name_or_path='dmis-lab/biobert-v1.1'
    cache_dir='/data_dir/MTL/tasks/cache_dia_pro_mp'
    lr=args.lr
    ...
    use_amp=False
    use_cuda=True
    task_weights = { "pro_plus":pro_plus,"dia_plus":dia_plus,"mp":mp}
