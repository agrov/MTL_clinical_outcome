...
from multitask_doc_classification_dia_los import doc_classification
...
def run_wrapper(config, *args, **kwargs):
    ...
    params.task_config='/data_dir/MTL/experiments/configs/dia_los_config.yaml'
    params.run_name='dia_los_1'
...
def run_hpo(args):
    ...
    analysis = ray.tune.run(
        run_wrapper,
        search_alg=search,
        local_dir='/data_dir/MTL/experiments/logs_tensor/dia_los/',
        scheduler=scheduler,
        fail_fast=True,
        **config
    )
