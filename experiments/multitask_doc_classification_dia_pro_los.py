...
def doc_classification(args):
    task_config='/data_dir/MTL/experiments/configs/dia_pro_los_config.yaml'
    run_name='dia_pro_los_0'
    model_name_or_path='/data_dir/MTL/experiments/models/core_model'
    cache_dir='/data_dir/MTL/tasks/cache_dia_pro_los'
    lr=args.lr
    ...
    use_amp=False
    use_cuda=True
    task_weights = { "pro_plus":pro_plus,"dia_plus":dia_plus,"los":los}
