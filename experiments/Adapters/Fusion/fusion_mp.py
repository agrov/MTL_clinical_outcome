...
""" Fusion for Mortality prediction"""
...
def doc_classification(config_file):
    ...
    training_args.output_dir="/data_dir/MTL/experiments/models/MP_Adapter_head/"
    ...
    if training_args.do_eval:
        ...
        # print(all_attention)
        import pickle
        openfile = open(os.path.join(training_args.output_dir, "attention_mp"), 'wb')
...
if __name__ == "__main__":
    ...
    doc_classification(config_file='/data_dir/MTL/experiments/Adapters/config/config_mp.json')
