...
""" AdapterFusion for Diagnosis task"""
...
def doc_classification(config_file):
    ...
    training_args.learning_rate = 0.00045763
    training_args.per_device_train_batch_size = batch_size
    training_args.per_device_eval_batch_size = batch_size
    training_args.num_train_epochs = 29.254
    training_args.eval_steps = 500
    training_args.weight_decay = 0.01
    training_args.load_best_model_at_end = True
    training_args.metric_for_best_model = "roc_auc"
    training_args.run_name = "dia_with_head_0"
    training_args.warmup_steps = 50
    training_args.gradient_accumulation_steps = 9
    training_args.evaluate_during_training = True
    training_args.do_eval = True
    training_args.seed = 11
    training_args.output_dir="/data_dir/MTL/experiments/models/DIA_Adapter_head/"
    ...
    if training_args.do_eval:
        ...
        # print(all_attention)
        import pickle
        openfile = open(os.path.join(training_args.output_dir, "attention_dia"), 'wb')
...
if __name__ == "__main__":
    ...
    doc_classification(config_file='/data_dir/MTL/experiments/Adapters/config/config_dia.json')
