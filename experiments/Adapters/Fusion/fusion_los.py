...
""" Fusion for length of Stay task"""
...
def doc_classification(config_file):
    ...
    training_args.learning_rate = 7.732e-05
    ...
    training_args.run_name = "los_with_head_0"
    training_args.warmup_steps = 676
    training_args.gradient_accumulation_steps = 9
    training_args.evaluate_during_training = True
    training_args.do_eval = True
    training_args.seed = 11
    training_args.output_dir="/data_dir/MTL/experiments/models/LOS_Adapter_head/"
...
if __name__ == "__main__":
    ...
    doc_classification(config_file='/data_dir/MTL/experiments/Adapters/config/config_los.json')
