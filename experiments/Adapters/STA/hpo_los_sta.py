...
""" HPO for Single Task Adapters-Length of Stay"""
...
def doc_classification(args, config_file, run_name, do_hpo=False):
    ...
    if do_hpo:
        ...
        best_trial = trainer.hyperparameter_search(direction="maximize",
                                                   ...
                                                   local_dir="/data_dir/MTL/experiments/Adapters/los_log/",
                                                   log_to_file=True,
...
if __name__ == "__main__":
    ...
    doc_classification(args, config_file='/data_dir/MTL/experiments/Adapters/config/config_los.json',
                       run_name='los_adap_0', do_hpo=True)
