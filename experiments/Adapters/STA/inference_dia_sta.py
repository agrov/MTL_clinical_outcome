...
""" Infer the Diagnosis model using a csv file-"inference_file"""""
...
def doc_classification(config_file,output_dir,adapter_path,inference_file):
    ...
    model.load_adapter(
        adapter_path,
        "text_task", config=PfeifferConfig(), with_head=True, load_as=data_args.task_name)
    ...
    if training_args.do_inference:
        ...
        with open(os.path.join(training_args.output_dir, "results_inference_sta.txt"), "w") as writer:
...
if __name__ == "__main__":
    ...
    #config_file="/home/anjali/MTL/experiments/Adapters/config/config_dia.json"
    #output_dir="/home/anjali/MTL/results/adapter_dia/sta"
    #adapter_path=output_dir
    #inference_file="/home/anjali/MTL/experiments/evaluation/filtered_ids_inference.csv"
    doc_classification(config_file,output_dir,adapter_path,inference_file)
