...
""" HPO for Single Task Adapters-Mortality Prediction"""
...
def doc_classification(args, config_file, run_name, do_hpo=False):
    ...
    def get_model():
        ...
        if adapter_args.train_adapter:
            ...
            model.add_adapter(trial_id if tune_session else data_args.task_name, AdapterType.text_task,
    ...
    if do_hpo:
        ...
        best_trial = trainer.hyperparameter_search(direction="maximize",
                                                   ...
                                                   local_dir="/data_dir/MTL/experiments/Adapters/mp_log/",
                                                   log_to_file=True,
...
def arg_parse(parser: ArgumentParser) -> ArgumentParser:
    ...
    parser.add_argument("--hpo_min_steps", default=20, type=int,
...
if __name__ == "__main__":
    ...
    doc_classification(args, config_file='/data_dir/MTL/experiments/Adapters/config/config_mp.json',
                       run_name='mp_adap_1', do_hpo=True)
