...
from farm.modeling.prediction_head import PredictionHead,FeedForwardBlock 
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if class_weights is not None:
            ...
            balanced_weights = nn.Parameter(torch.tensor(class_weights, dtype=torch.float), requires_grad=False)
        else:
