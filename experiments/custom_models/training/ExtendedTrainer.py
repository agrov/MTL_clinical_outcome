    ...
    def train(self, score_callback=None):
            ...
            for step, batch in enumerate(progress_bar):
                ...
                if self.evaluate_every != 0 \
                    ...
                    if dev_data_loader is not None:
                        ...
                        evalnr += 1
                        result,multi_roc_auc = evaluator_dev.eval(self.model)
                        ...
                        if self.early_stopping:
                            ...
                            if score_callback:
                                score_callback(eval_score=multi_roc_auc, train_loss=loss.cpu())
        ...
        if self.evaluator_test:
            ...
            if test_data_loader is not None:
                ...
                self.test_result,multi_roc_auc_test = evaluator_test.eval(self.model)
